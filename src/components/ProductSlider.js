...
export default function ProductSlider({ items = [] }) {
    ...
    return (
        <div className="bg-[#0054A6] w-full">
            ...
            <section className="relative bg-[#0054A6] h-[420px] px-4 sm:px-6 md:px-14 overflow-visible flex flex-col items-center">
                <div
                    ref={prevRef}
                    className="absolute left-4 top-1/2 transform -translate-y-1/2 z-20"
                >
                    <button className="text-white bg-[#0054A6] border border-white rounded-full p-2 shadow-md hover:bg-blue-900 transition">
                        <FaArrowLeft size={20} />
                    </button>
                </div>
                <div
